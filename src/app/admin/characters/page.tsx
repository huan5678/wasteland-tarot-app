    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="px-6 py-3 border-2 border-pip-boy-green bg-pip-boy-green/20 hover:bg-pip-boy-green/30 transition-colors flex items-center gap-2 font-bold uppercase tracking-wider"
        >
        ...
        <div className="flex gap-2">
          {(['all', 'active', 'inactive'] as const).map((filter) => (
            <button
              ...
              className={`px-4 py-3 border-2 transition-colors uppercase text-sm font-bold tracking-wider ${
                filterActive === filter
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-4 py-2 border-2 border-pip-boy-green bg-pip-boy-green/20 hover:bg-pip-boy-green/30 text-pip-boy-green font-bold uppercase text-sm tracking-wider transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                {isBulkProcessing ? (
              ...
              <button
                ...
                disabled={isBulkProcessing}
                className="px-4 py-2 border-2 border-orange-400 bg-orange-500/20 hover:bg-orange-500/30 text-orange-400 font-bold uppercase text-sm tracking-wider transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                {isBulkProcessing ? (
                  <PixelIcon name="loader" sizePreset="xs" animation="spin" decorative className="inline" />
                ) : (
              ...
              <button
                ...
                disabled={isBulkProcessing}
                className="px-4 py-2 border-2 border-red-500 bg-red-500/20 hover:bg-red-500/30 text-red-400 font-bold uppercase text-sm tracking-wider transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                {isBulkProcessing ? (
              ...
              <button
                ...
                disabled={isBulkProcessing}
                className="px-4 py-2 border-2 border-pip-boy-green/30 text-pip-boy-green/70 hover:border-pip-boy-green/60 font-bold uppercase text-sm tracking-wider transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                取消選擇
              </button>
            </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="flex gap-4 pt-4 border-t-2 border-pip-boy-green/30">
            <button
              ...
              onClick={onClose}
              disabled={isSaving}
              className="flex-1 px-6 py-3 border-2 border-pip-boy-green/30 hover:border-pip-boy-green/60 transition-colors font-bold uppercase tracking-wider disabled:opacity-50"
            >
              取消
            </button>
            <button
              type="submit"
              disabled={isSaving}
              className="flex-1 px-6 py-3 border-2 border-pip-boy-green bg-pip-boy-green/20 hover:bg-pip-boy-green/30 transition-colors font-bold uppercase tracking-wider flex items-center justify-center gap-2 disabled:opacity-50"
            >
              {isSaving ? (
                <>
