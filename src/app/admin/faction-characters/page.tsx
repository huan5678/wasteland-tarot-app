...
import {
  useFactions,
  useCharacters,
  clearFactionsCache } from
'@/hooks/useCharacterVoices';
import {
  getFactionsWithCharacters,
  addCharacterToFaction,
  removeCharacterFromFaction,
  updateFactionCharacterPriority } from
'@/lib/api/character-voice';
import type {
  Faction,
  Character,
  FactionWithCharacters } from
                    ...
                    <table className="w-full">
                      ...
                      <tbody className="divide-y divide-pip-boy-green/20">
                        ...
                        <tr key={character.id} className="hover:bg-pip-boy-green/5 transition-colors">
                            ...
                            className="px-3 py-1 border font-bold uppercase tracking-wider transition-colors inline-flex items-center gap-2">
