...
import { ProgressBar, type ProgressStats } from '@/components/ui/ProgressBar'
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  {interpretations.length > 0 && (
                    <button
                      ...
                      className="text-sm text-pip-boy-green/80 hover:text-pip-boy-green underline"
                    >
        ...
        <div className="flex items-start justify-between mb-2">
          <div className="flex items-center gap-3 flex-1">
            ...
            <button
              ...
              className="text-sm text-pip-boy-green/70 hover:text-pip-boy-green flex items-center gap-1"
            >
              <PixelIcon
