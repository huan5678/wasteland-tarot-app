        ...
        <div className="border-2 border-pip-boy-green bg-pip-boy-green/10 p-4 mb-6">
          <div className="flex justify-between items-center">
            ...
            {!isEditing && (
              <button
                onClick={handleEdit}
                className="px-4 py-2 border border-pip-boy-green text-pip-boy-green font-mono hover:bg-pip-boy-green/10 transition-colors"
              >
          ...
          <div className="lg:col-span-1">
            <div className="border-2 border-pip-boy-green/30 bg-pip-boy-green/5 p-6">
              <div className="text-center mb-6">
                ...
                {isOAuthUser && (
                  <div className="mt-2 inline-flex items-center gap-2 px-3 py-1 border border-pip-boy-green/50 bg-pip-boy-green/10 rounded-full">
                    ...
                    <span className="text-pip-boy-green font-mono text-xs">已連結 Google 帳號</span>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="text-center">
                  <div className="text-lg font-bold text-pip-boy-green font-mono">
                    {profile.karmaLevel}
                  </div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-pip-boy-green/70 text-xs font-mono">總占卜次數</div>
                </div>
              </div>
            </div>
            ...
            <div className="border-2 border-pip-boy-green/30 bg-pip-boy-green/5 p-4 mt-6">
              <h3 className="text-pip-boy-green font-mono font-bold mb-3">快速動作</h3>
              <div className="space-y-2">
                <Link
                  href="/readings/new"
                  className="block text-center py-2 border border-pip-boy-green/50 text-pip-boy-green hover:border-pip-boy-green hover:bg-pip-boy-green/10 transition-colors font-mono text-sm"
                >
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              {isEditing ? (
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="w-full px-3 py-2 bg-black/50 border border-pip-boy-green/50 text-pip-boy-green font-mono">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      maxLength={50}
                    />
                    <p className="text-pip-boy-green/50 font-mono text-xs mt-1">
                      可編輯 (1-50 字元)
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      disabled
                      className="w-full px-3 py-2 bg-black/50 border border-pip-boy-green/50 text-pip-boy-green/70 font-mono cursor-not-allowed"
                    />
                    <p className="text-pip-boy-green/50 font-mono text-xs mt-1">
                      Email 無法變更
                    </p>
                  ...
                  <div className="flex gap-4">
                    ...
                    <button
                      ...
                      disabled={isSaving}
                      className="flex-1 py-2 border border-pip-boy-green text-pip-boy-green font-mono hover:bg-pip-boy-green/10 disabled:opacity-50 transition-colors"
                    >
                      取消
                    </button>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:col-span-2">
                      <p className="text-pip-boy-green/70 font-mono text-sm">登入方式</p>
                      <p className="text-pip-boy-green font-mono">
                        {isOAuthUser ? (
                    ...
                    <div>
                      <p className="text-pip-boy-green/70 font-mono text-sm">名稱</p>
                      <p className="text-pip-boy-green font-mono">{user?.name || profile.username}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-pip-boy-green font-mono">{user?.email || profile.email}</p>
                    </div>
                    <div>
                      <p className="text-pip-boy-green/70 font-mono text-sm">加入日期</p>
                      <p className="text-pip-boy-green font-mono">{formatDate(profile.joinDate)}</p>
                    </div>
                    <div>
                      <p className="text-pip-boy-green/70 font-mono text-sm">陣營歸屬</p>
                      <p className="text-pip-boy-green font-mono">{profile.faction}</p>
                    </div>
                    <div>
                      <p className="text-pip-boy-green/70 font-mono text-sm">Pip-Boy 型號</p>
                      <p className="text-pip-boy-green font-mono">{profile.pipBoyModel}</p>
                    </div>
                  </div>
                </div>
              )}
            ...
            <div className="border-2 border-pip-boy-green/30 bg-pip-boy-green/5 p-6">
              ...
              <div className="space-y-3">
                <label className="flex items-center text-pip-boy-green font-mono text-sm">
                  <input
                    type="checkbox"
            ...
            <div className="border-2 border-pip-boy-green/30 bg-pip-boy-green/5 p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="text-center">
                  <div className="text-xl font-bold text-pip-boy-green font-mono">12</div>
                  <div className="text-pip-boy-green/70 text-xs font-mono">本月</div>
                </div>

                <div className="text-center">
                  <div className="text-xl font-bold text-pip-boy-green font-mono">7</div>
                  <div className="text-pip-boy-green/70 text-xs font-mono">收藏</div>
                </div>

                <div className="text-center">
                  <div className="text-sm font-bold text-pip-boy-green font-mono">
                    {profile.favoriteCard}
                  </div>
                  <div className="text-pip-boy-green/70 text-xs font-mono">最常抽到</div>
                </div>
              </div>
            </div>
            ...
            <div className="border-2 border-red-400/30 bg-red-900/10 p-6">
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-red-400/80 font-mono text-sm mb-2">
                    登出所有 Pip-Boy 會話
                  </p>
                  <button
                    onClick={logout}
                    className="px-4 py-2 border border-red-400 text-red-400 font-mono hover:bg-red-400/10 transition-colors"
                  >
