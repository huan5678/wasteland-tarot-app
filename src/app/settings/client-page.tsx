  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        ...
        className="p-4 transition-colors flex items-center gap-3">
      ...
      <div className="flex gap-2 mb-6 border-b border-pip-boy-green/20 overflow-x-auto">
        ...
        className={`px-4 py-2 transition-colors ${activeTab === 'reading' ? 'border-b-2 border-pip-boy-green text-pip-boy-green' : 'text-wasteland-tan/60 hover:text-pip-boy-green'}`}>
        ...
        className={`px-4 py-2 transition-colors ${activeTab === 'interpretation' ? 'border-b-2 border-pip-boy-green text-pip-boy-green' : 'text-wasteland-tan/60 hover:text-pip-boy-green'}`}>
        ...
        className={`px-4 py-2 transition-colors ${activeTab === 'notifications' ? 'border-b-2 border-pip-boy-green text-pip-boy-green' : 'text-wasteland-tan/60 hover:text-pip-boy-green'}`}>
        ...
        className={`px-4 py-2 transition-colors ${activeTab === 'privacy' ? 'border-b-2 border-pip-boy-green text-pip-boy-green' : 'text-wasteland-tan/60 hover:text-pip-boy-green'}`}>
        ...
        className={`px-4 py-2 transition-colors ${activeTab === 'security' ? 'border-b-2 border-pip-boy-green text-pip-boy-green' : 'text-wasteland-tan/60 hover:text-pip-boy-green'}`}>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              ...
              <label className="flex items-center justify-between p-3 rounded hover:bg-pip-boy-green/5 cursor-pointer">
                ...
                onChange={(e) => updateReadingSettings({ share_readings_publicly: e.target.checked })}
                className="w-5 h-5" />
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                className="w-full px-3 py-2 rounded bg-wasteland-dark border border-pip-boy-green/40 text-pip-boy-green focus:outline-none focus:border-pip-boy-green">
              ...
              <div>
                ...
                className={`p-2 transition-colors ${preferences.interpretation_depth === depth ? 'bg-pip-boy-green text-black' : 'bg-wasteland-dark border border-pip-boy-green/40'}`}>
                      {depth === 'simple' && '簡單'}
                      {depth === 'medium' && '中等'}
                      {depth === 'deep' && '深入'}
                    </Button>
              ...
              <div>
                ...
                className={`p-2 transition-colors ${preferences.interpretation_style === value ? 'bg-pip-boy-green text-black' : 'bg-wasteland-dark border border-pip-boy-green/40'}`}>
                      {label}
                    </Button>
                )}
                </div>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-center justify-between p-3 rounded hover:bg-pip-boy-green/5 cursor-pointer">
                ...
                onChange={(e) => updateNotificationSettings({ enable_friend_notifications: e.target.checked })}
                className="w-5 h-5" />
              ...
              <label className="flex items-center justify-between p-3 rounded hover:bg-pip-boy-green/5 cursor-pointer">
                ...
                onChange={(e) => updateNotificationSettings({ enable_community_notifications: e.target.checked })}
                className="w-5 h-5" />
