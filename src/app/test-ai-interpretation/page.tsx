          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <button
                onClick={drawCards}
                disabled={isDrawing}
                className="flex-1 bg-pip-boy-green text-black font-bold py-3 px-6 border-2 border-pip-boy-green hover:bg-black hover:text-pip-boy-green transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isDrawing ? (
                  <>
              ...
              <button
                ...
                className="flex-1 bg-radiation-orange text-black font-bold py-3 px-6 border-2 border-radiation-orange hover:bg-black hover:text-radiation-orange transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isLoading ? (
                  <>
                    <PixelIcon name="loader" animation="spin" sizePreset="sm" />
