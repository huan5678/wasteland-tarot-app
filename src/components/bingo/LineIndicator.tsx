      ...
      >
        ...
        >
          <div className="inline-flex items-baseline gap-2">
            ...
            <span className="text-3xl text-gray-400">/ {targetLines}</span>
          </div>
          <p className="text-gray-400 text-sm mt-2">連線數</p>
        </motion.div>
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          ...
          <div className="text-center p-2 bg-gray-900/50 border border-gray-700 rounded">
            ...
            <p className="text-xs text-gray-400">橫向</p>
          </div>

          {/* 縱向 */}
          <div className="text-center p-2 bg-gray-900/50 border border-gray-700 rounded">
            <div className="text-2xl mb-1 rotate-90">━</div>
            <p className="text-xs text-gray-400">縱向</p>
          </div>

          {/* 對角線 */}
          <div className="text-center p-2 bg-gray-900/50 border border-gray-700 rounded">
            <div className="text-2xl mb-1 rotate-45">━</div>
            <p className="text-xs text-gray-400">對角線</p>
          </div>
        </div>
