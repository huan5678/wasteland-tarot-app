      ...
      return (
        <div className="text-center py-8">
          ...
          <button
            ...
            className="mt-4 px-4 py-2 bg-pip-boy-green text-wasteland-dark font-cubic text-sm hover:bg-pip-boy-green/90 transition-colors"
            aria-label="建立日記"
          >
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3 pt-4 border-t border-pip-boy-green">
          <button
            type="button"
            onClick={handleStartEdit}
            className="px-4 py-2 border border-pip-boy-green text-pip-boy-green font-cubic text-sm hover:bg-pip-boy-green/10 transition-colors"
            aria-label="編輯日記"
          >
          ...
          <button
            ...
            className="px-4 py-2 border border-red-500 text-red-500 font-cubic text-sm hover:bg-red-900/20 transition-colors"
            aria-label="刪除日記"
          >
  ...
  return (
    <div className="reading-journal-section bg-wasteland-dark/50 border border-pip-boy-green">
      ...
      <button
        ...
        className="w-full px-6 py-4 flex items-center justify-between hover:bg-pip-boy-green/5 transition-colors"
