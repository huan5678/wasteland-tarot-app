          ...
          <div className="space-y-2">
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 p-3 border rounded transition-all ${
                selectedTitle === null
                  ? 'border-pip-boy-green bg-pip-boy-green/10 shadow-[0_0_8px_rgba(0,255,136,0.3)]'
                  : 'border-pip-boy-green/30 bg-wasteland-dark hover:border-pip-boy-green/50 hover:bg-pip-boy-green/5'
              }`}
            >
              {/* Radio Button */}
