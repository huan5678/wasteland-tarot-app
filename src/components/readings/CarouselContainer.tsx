...
import { useAudioEffect } from '@/hooks/audio/useAudioEffect';import { Button } from "@/components/ui/button";
  ...
  return (
    <div
      ...
      <div className="relative flex justify-center">
        ...
        className="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 flex items-center justify-center disabled:opacity-30 disabled:cursor-not-allowed transition-colors z-10"
        aria-label="上一張卡牌"
        ...
        className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 flex items-center justify-center disabled:opacity-30 disabled:cursor-not-allowed transition-colors z-10"
        aria-label="下一張卡牌"
