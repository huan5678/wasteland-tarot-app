  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border-2 border-pip-boy-green/30 bg-pip-boy-green/5 p-6 space-y-4">
          ...
          className="px-4 py-2 border disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2">
            ...
            <div
              ...
              <div className="space-y-2">
                ...
                <div className="border-t border-pip-boy-green/30 pt-3 space-y-3">
                  ...
                  className="w-full px-3 py-2 border flex items-center justify-center gap-2">
      ...
      <div className="text-center py-12 border-2 border-pip-boy-green/30">
          ...
          <Button size="sm" variant="outline"
        onClick={startCreate}
        className="px-4 py-2 border flex items-center gap-2 mx-auto">
