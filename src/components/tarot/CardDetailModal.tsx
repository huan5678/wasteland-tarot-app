...
import { Button } from "@/components/ui/button";export interface DetailedTarotCard {
  id: string | number;
  name: string;
  description?: string;
  suit: string;
...
}: {voices: {[key: string]: string;};selectedVoice: string;onVoiceChange: (voice: string) => void;enableAudio?: boolean;card?: DetailedTarotCard;characters?: any[];}) => {
