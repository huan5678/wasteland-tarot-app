...
import { useSpreadTemplatesStore } from '@/lib/spreadTemplatesStore';import { Button } from "@/components/ui/button";
      ...
      return (
        <div className="space-y-6">
          ...
          <div className="relative w-full">
            ...
            className="absolute left-2 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center justify-center disabled:opacity-30 disabled:cursor-not-allowed transition-colors">
            ...
            className="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center justify-center disabled:opacity-30 disabled:cursor-not-allowed transition-colors">
